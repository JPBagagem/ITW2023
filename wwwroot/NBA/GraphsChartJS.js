    ...
    ajaxHelper(composedUri, 'GET').done(function (stats) {
        ...
        new Chart(ctx, {
            ...
            data: {
                labels: myLabels,
                datasets: [{
                    label: 'N.º de Jogadores por Regular Season',
                    data: myData,
                    borderWidth: 1
                }]
            },
            options: {
                ...
                plugins: {
                    legend: {
                        ...
                        title: {
                            display: true, text: ['Estatísticas Gerais', 'N.º de Jogadores por Season'], padding: { top: 10, bottom: 10 }, font: { size: 12, family: 'Open Sans' }
                        },
                    }
                },
                indexAxis: 'y',
